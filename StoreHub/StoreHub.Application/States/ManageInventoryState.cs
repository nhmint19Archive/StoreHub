...
using StoreHub.Domain.Services;
...
internal class ManageInventoryState : AppState
{
    ...
    {
        var name = _inputHandler.AskUserTextInput($"Enter the name of the product. Type nothing and press [Enter] to exit.");
        ...
        var description = _inputHandler.AskUserTextInput($"Enter the description of the product. Type nothing and press [Enter] to exit.");
        ...
        while (!_inputHandler.TryAskUserTextInput(
                   ...
                   out price,
                   $"Please type the price of the product. Type nothing and press [Enter] to exit.",
        ...
        while (!_inputHandler.TryAskUserTextInput(
                   ...
                   out inventoryCount,
                   $"Please type the quantity of the product. Type nothing and press [Enter] to exit.",
                   "Invalid input. Input must be empty or a valid number"))
        { }
    ...
    private void UpdateProductPrice()
    {
        ...
        while (!_inputHandler.TryAskUserTextInput(
                   ...
                   x => string.IsNullOrEmpty(x) ? null : int.Parse(x),
                   out id,
                   $"Please type the ID of the product. Type nothing and press [Enter] to exit."))
        {
        }
